...
% REGION style (final — authors visible)
\usepackage[final]{region}
\usepackage{hyperref}
\hypersetup{
  pdftitle={Policy Attention versus Institutional Supply: How Local Governments Foster Cluster Resilience},
  pdfauthor={Yiwen Sun, Yanlin Shi, Jiarui Liang},
...
\bottomrule
\multicolumn{4}{p{11cm}}{\footnotesize\textit{Note:} Total paragraph-level documents = 419. Keywords are English translations of Chinese GWR tokens segmented by jieba.} \\
\end{tabular}
\end{table}
