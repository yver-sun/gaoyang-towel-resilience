...
\begin{figure}[htbp]
    ...
    \caption{Synthetic Control Method (SCM) analysis of the 2017 environmental regulation shock. Panel (a): Gaoyang vs.\ synthetic trajectory; Panel (b): placebo tests for all 23 counties.}
    \label{fig:scm}
\end{figure}
